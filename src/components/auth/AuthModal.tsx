...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-xs animate-in fade-in duration-150">
      <div
        className="w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150"
        role="dialog"
        aria-modal="true"
      >
        {/* Modal Header */}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-slate-100 font-display">
                {mode === 'signin' ? 'Welcome Back to Learn.co' : 'Create Learn.co Account'}
              </h3>
              <p className="text-xs text-slate-400">
                {mode === 'signin'
                  ? 'Sign in to access your learning matrix & streak'
          ...
          <div className="pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 rounded-lg border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-100 cursor-pointer"
              >
                Alex Vance (85 XP, 4d)
              </button>
              <button
                ...
                className="px-2.5 py-1 text-[11px] font-semibold bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-200 cursor-pointer"
              >
                Elena Rostova (1420 XP)
              </button>
            </div>
          </div>
        </div>
